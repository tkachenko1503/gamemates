...
const STEAM_GAMES_URL = 'http://api.steampowered.com/IPlayerService/GetOwnedGames/v0001/';
...
const extractGames = r.pipe(r.map(r.prop('games')), r.flatten);
...
app.post('/mates', (req, res) => {
  ...
  axios.all(requestAllSteamIds(mates))
